...
<section class="page-hero<?php echo $hero_image ? ' page-hero--image' : ''; ?>"
	...
	<div class="page-hero__container">
		...
		<span class="page-hero__eyebrow"><?php esc_html_e( 'Samen sterker', 'eboh' ); ?></span>
...
<main id="main" class="page-shell">
	<div class="page-container">
		...
		<?php else : ?>
			<p style="opacity:0.7;font-size:15px;"><?php esc_html_e( 'Voeg via de pagina-editor de inhoud toe (sponsorpakketten, partneroverzicht, contactblok).', 'eboh' ); ?></p>
		<?php endif; ?>
	</div>
</main>
